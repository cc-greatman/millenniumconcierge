        ...
        <div class="row">
                ...
                <div class="services4">
                    ...
                    <div class="service-wrap">
                        <div class="service-cont">
                            ...
                            <p class="service-text">* Access to Private Jet Charter at no extra charge</p>
                            <p class="service-text" style="margin-top: -10px;">* Access to Exclusive High Value Domestic and
            ...
            <div class="col-lg-4 col-md-6 mb-30">
                <div class="services4">
                    ...
                    <div class="service-header">
                        <h3 class="service-label">Platinum Membership</h3>
                    </div>
                    <div class="service-wrap">
                        <div class="service-cont">
                            <h4 class="service-title"><a href="#" style="background-image: linear-gradient(to right, #DFBF81, #BF9A53);
