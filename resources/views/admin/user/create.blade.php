          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">User Creation</li>
              </ul>
            </div>
            <div class="col-md-12">
              <div class="page-header-title">
                <h2 class="mb-0">Create a New User</h2>
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="mb-3">
                      ...
                      <small class="form-text text-muted">Enter user's first name</small>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="mb-3">
