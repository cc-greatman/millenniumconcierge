      ...
      <div class="navbar-content">
        <ul class="pc-navbar">
          ...
          <li class="pc-item pc-hasmenu  @if (Request::is('user.trips') || Request::is('user/trips/*')) pc-trigger active @endif">
            ...
            <ul class="pc-submenu">
              <li class="pc-item @if(Route::is('membership.plans.view')) active @endif"><a class="pc-link" href="{{ route('membership.plans.view') }}">All</a></li>
              <li class="pc-item @if(Route::is('membership.plans.view')) active @endif"><a class="pc-link" href="{{ route('membership.plans.view') }}">Completed</a></li>
              <li class="pc-item @if(Route::is('membership.plans.view')) active @endif"><a class="pc-link" href="{{ route('membership.plans.view') }}">Pending</a></li>
            </ul>
          </li>
          <li class="pc-item pc-hasmenu  @if (Request::is('user.trips') || Request::is('user/trips/*')) pc-trigger active @endif">
            <a href="javascript:void(0);" class="pc-link">
