      ...
      <div class="navbar-content">
        <ul class="pc-navbar">
          ...
          <li class="pc-item pc-hasmenu">
            <a href="#!" class="pc-link @if (Route::is('user.dashboard')) active @endif">
              <span class="pc-micon">
                <i class="ph-duotone ph-gauge"></i>
              </span>
          ...
          <li class="pc-item pc-hasmenu  @if (Request::is('membership') || Request::is('membership/*')) pc-trigger active @endif">
            ...
            <ul class="pc-submenu">
              ...
              <li class="pc-item @if(Route::is('membership.plans.view')) active @endif"><a class="pc-link" href="membership-pricing.html">Plans</a></li>
        ...
        <div class="card nav-action-card bg-brand-color-4">
          <div class="card-body" style="background-image: linear-gradient(to right, #DFBF81, #BF9A53) !important; border-radius: 12px; border: 0px;">
            ...
            <a href="mailto:help@millenniumconcierge.com" style="color: white" class="btn btn-dark" target="_blank">Go to help Center</a>
          </div>
        </div>
      </div>
              ...
              <div class="dropdown">
                <a href="javascript:void(0);" class="arrow-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" data-bs-offset="0,20">
                  <div class="d-flex align-items-center">
                    <div class="flex-grow-1 me-2">
                      ...
                      <small>{{ checkMembership($user) }}</small>
                    </div>
                ...
                <div class="dropdown-menu">
                  <ul>
                    ...
                    <li>
                      <a class="pc-user-links" href="{{ route('user.logout') }}">
